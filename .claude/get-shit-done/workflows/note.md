...
- **Global scope**: `/Users/y3/radar/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/y3/radar/.claude/notes/`)
...
2. Glob `/Users/y3/radar/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/y3/radar/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/y3/radar/.claude/notes/` — works in any directory
